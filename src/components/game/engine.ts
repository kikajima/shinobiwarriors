...
import { EL_LIST, maxHpOf, TILE, } from './types';
...
export class GameEngine {
    ...
    findTarget(range){let best=null,bestD=Infinity;for(const e of this.entities.values()){if(e.kind!=='monster'||e.id===this.selfId)continue;const d=Math.hypot(e.x-this.selfX,e.y-this.selfY);if(d<range&&d<bestD){best=e;bestD=d;}}return best;}
