...
import type { RosterEnt } from '../types'
...
export function PlayersPanel({ players, selfId, open }: PlayersPanelProps) {
  ...
  return (
    <div className="pointer-events-auto absolute right-2 top-[132px] z-20 sm:right-3 sm:top-[148px]">
      <PixelPanel className="w-[200px] !p-2" title={`ONLINE (${players.length})`}>
              ...
              return (
                ...
                >
                  <span className="flex min-w-0 items-center gap-1">
                    ...
                    <span className={`truncate ${isSelf ? 'text-[#ffb347]' : 'text-[#e8d5a9]'}`}>{p.n}</span>
                  </span>
